---
title: "PIB Xº Trimestre de YYYY - Template"
author:
- Arthur Welle
- Gabriel Mandarino
- Gabriel Petrini
...
Tabela_Resumo_Setores <- data.frame(
    "Agropecuária" = c(
                      coredata(last(Trim_Trim_Anterior_xts$Agropecuaria, n = "2 quarter")),
                      FazTexto.ValorMesAntes(Trim_Trim_Anterior$Agropecuaria, 
                                             meses = 5,
                                             texto = FALSE),
    ...
    "Indústria" = c(
                      coredata(last(Trim_Trim_Anterior_xts$`Total Industria`, n = "2 quarter")),
                      FazTexto.ValorMesAntes(Trim_Trim_Anterior$`Total Industria`, 
                                             meses = 5,
                                             texto = FALSE),
                      ...
                      FazTexto.TaxaAccMeses(x = Trim_Trim_Anterior$`Total Industria`, 
                                            meses = 4, 
                                            texto = FALSE),
                      FazTexto.TaxaAnualizada(x = Trim_Trim_Anterior$`Total Industria`,
                                              texto = FALSE)
                    ),
    "Serviços" = c(
                      coredata(last(Trim_Trim_Anterior_xts$`Total Servicos`, 
                                  n = "2 quarter")),
                      FazTexto.ValorMesAntes(Trim_Trim_Anterior$`Total Servicos`, 
                                             meses = 5, 
                                             texto = FALSE),
                      ...
                      FazTexto.TaxaAccMeses(x = Trim_Trim_Anterior$`Total Servicos`, 
                                            meses = 4, 
                                            texto = FALSE),
                      FazTexto.TaxaAnualizada(x = Trim_Trim_Anterior$`Total Servicos`,
                                              texto = FALSE)
                    ),
    "PIB" = c(
                      coredata(last(Trim_Trim_Anterior_xts$PIB, n = "2 quarter")), 
...
Tabela_Resumo_VA <- data.frame(
    "Valor Adicionado" = c(
                      coredata(last(Trim_Trim_Anterior_xts$VA,
                                  n = "2 quarters")),
...
Tabela_Resumo_Demanda <- data.frame(
    "Fam" = c(
                    coredata(last(Trim_Trim_Anterior_xts$`Consumo das Familias`,
                                  n = "2 quarters")),
    ...
    "Gov" = c(
                      coredata(last(Trim_Trim_Anterior_xts$`Consumo do Governo`,
                                  n = "2 quarters")),
    ...
    "FBCF" = c(
                      coredata(last(Trim_Trim_Anterior_xts$FBCF,
                                  n = "2 quarters")),
    ...
    "Export" = c(
                      coredata(last(Trim_Trim_Anterior_xts$Exportacao,
                                  n = "2 quarters")),
    ...
    "Import" = c(
                      coredata(last(Trim_Trim_Anterior_xts$Importacao,
                                  n = "2 quarters")),
    ...
    "PIB" = c(
                      coredata(last(Trim_Trim_Anterior_xts$PIB,
                                  n = "2 quarters")),
                      FazTexto.VarMes.porc(Encade95_AjusSaz$PIB, 
                                          meses = 4, 
                                          texto = FALSE),
